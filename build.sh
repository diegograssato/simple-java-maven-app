...
echo -e "${BG}[✓] BUILDING my project...${NONE}"
echo -e "${BR}[✓] BUILDING my project...${NONE}"
echo -e "${BY}[✓] BUILDING my project...${NONE}"
echo -e "${BC}[✓] BUILDING my project...${NONE}"
echo -e "${BK}[✓] BUILDING my project...${NONE}"